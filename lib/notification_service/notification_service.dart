...
class NotificationService {
  ...
  Future<void> scheduleNotification(String title, String body) async {
    ...
    final location =
        tz.getLocation('Asia/Dhaka'); // Replace with your desired timezone

    final tzScheduledDateTime = tz.TZDateTime.now(location)
        .add(const Duration(seconds: 5)); // Replace '5' with your desired delay
    ...
    final int notificationId =
        tzScheduledDateTime.millisecondsSinceEpoch ~/ 1000;

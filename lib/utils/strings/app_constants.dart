class AppConstants {
  ...
  static const String payoutUri = '/api/payout-method';
  ...
  static const String paymentDoneUri = '/api/payment/done?trx_id=';
  ...
  static const String depositUri = '/api/deposit';
  static const String webviewUri = '/api/payment-webview?trx_id=';
  static const String buyPlanUri = '/api/plan-buy';
  static const String payoutRequestUri = '/api/payout';
  static const String payoutConfirmUri = '/api/payout/submit/confirm';
  static const String flutterWaveUri = '/api/payout/flutterwave/submit';
  static const String paystackSubmitUri = '/api/payout/paystack/submit/';
  static const String getKycUri = '/api/kyc';
  static const String getKycSubmissionUri = '/api/kyc/submit';
  static const String getKycSubmissionListUri = '/api/user-kyc';
}

                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "${dashBoardController.dashBoardModel.message!.currency}${dashBoardController.dashBoardModel.message!.mainBalance!.toString()}",
                                          style: GoogleFonts.publicSans(
                                              fontSize: 15.sp,
                                              fontWeight: FontWeight.w700,
                                              color:
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "${dashBoardController.dashBoardModel.message!.currency}${dashBoardController.dashBoardModel.message!.totalDeposit!.toString()}",
                                          style: GoogleFonts.publicSans(
                                              fontSize: 14.sp,
                                              fontWeight: FontWeight.w700,
                                              color:
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          "${dashBoardController.dashBoardModel.message!.currency}${dashBoardController.dashBoardModel.message!.totalEarn!.toString()}",
                                          style: GoogleFonts.publicSans(
                                              fontSize: 15.sp,
                                              fontWeight: FontWeight.w700,
                                              color:

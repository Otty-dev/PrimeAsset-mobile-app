class ViewTicketModel {
  ...
  ViewTicketModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'] != null ? new ViewTicketData.fromJson(json['message']) : null;
  }
...
class ViewTicketData {
  ...
  ViewTicketData({this.id, this.pageTitle, this.userImage, this.userUsername, this.status, this.messages});
...
class Messages {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.attachments != null) {
      data['attachment'] = this.attachments!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class PayoutBankFormModel {
  ...
  PayoutBankFormModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'] != null ? new PayoutBankFormData.fromJson(json['message']) : null;
  }
...
class PayoutBankFormData {
  ...
  PayoutBankFormData.fromJson(Map<String, dynamic> json) {
    ...
    inputForm = json['input_form'] != null ? new InputForm.fromJson(json['input_form']) : null;
  }
...
class InputForm {
  ...
  InputForm({this.accountNumber, this.narration, this.reference, this.beneficiaryName});
